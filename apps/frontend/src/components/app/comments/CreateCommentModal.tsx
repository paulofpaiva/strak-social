...
interface CreateCommentModalProps {
  ...
  postId: string
  redirectTo?: 'post' | 'comment'
}

export function CreateCommentModal({ isOpen, onClose, parentCommentId, postId, redirectTo = 'comment' }: CreateCommentModalProps) {
  ...
  const createReplyMutation = useMutation({
    ...
    onSuccess: () => {
      toastSuccess(parentCommentId ? 'Reply posted successfully!' : 'Comment posted successfully!')
      reset()
      setImages([])
      clearErrors()
      onClose()
  ...
  return (
    <ResponsiveModal
      isOpen={isOpen}
      onClose={handleClose}
      title={parentCommentId ? "Reply" : "Comment"}
    ...
    >
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        <div className="space-y-2">
          <Textarea
            {...register("content")}
            placeholder={parentCommentId ? "What's your reply?" : "What's your comment?"}
