...
ALTER TABLE "comments_media" ADD CONSTRAINT "comments_media_comment_id_comments_id_fk" FOREIGN KEY ("comment_id") REFERENCES "public"."comments"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "comment_likes_user_comment_idx" ON "comment_likes" USING btree ("user_id","comment_id");--> statement-breakpoint
